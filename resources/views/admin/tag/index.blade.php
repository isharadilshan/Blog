                ...
                <div class="col-12">
                    <div class="card bg-dark">
                        <div class="card-header border-bottom">
                            ...
                            <a href="{{ route('tag.create') }}"><button type="submit" class="float-right btn btn-common mr-3">Create New</button></a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach($tags as $tag)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('tag.show',$tag->id) }}"><span class="fa fa-eye"></span></a></td>
                                                <td>
